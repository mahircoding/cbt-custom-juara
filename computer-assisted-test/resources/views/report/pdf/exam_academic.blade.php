<html>
    ...
    <body>
        ...
        <center>    
            <div class="title">
                <h3>REKAPITULASI NILAI TRYOUT AKADEMIK</h3>
            </div>
        </center>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{ $grade->nilai_mtk ? 'Penalaran Numerik' : '' }}
        ...
        <table width="100%" border="1">
            ...
            @php
                $arrayLabel = ['Wawasan Kebangsaan', 'Penalaran Numerik', 'Pengetahuan Umum', 'Bahasa Inggris'];
                ...
                @for ($i = 0; $i < count($arrayGrade); $i++)
                    @if ($grade->{'nilai_'.$arrayGrade[$i]})
                        <tr>
                            <td>{{ $no }}</td>
                            <td>{{ $arrayLabel[$i] }}</td>
                            <td>{{ $grade->{$arrayGrade[$i].'_ke'} ? 'Tryout Ke '.$grade->{$arrayGrade[$i].'_ke'} : '-' }}</td>
