                                ...
                                <div class="col-lg-4 col-md-6 mb-5" data-aos="fade-up" data-aos-delay="100">
                                    <a class="card text-center text-decoration-none h-100 lift">
                                        <div class="card-body py-5">
                                            ...
                                            <p class="card-text small">Sistem penilaian untuk kategori peminatan sesuai dengan sistem yang sebenarnya, sehingga Peserta dapat mengetahui ambang batas nilai di kategori tersebut.</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-lg-4 col-md-6 mb-5" data-aos="fade-up" data-aos-delay="150">
                                    <a class="card text-center text-decoration-none h-100 lift">
                                        <div class="card-body py-5">
                                            ...
                                            <p class="card-text small">Peserta dapat melihat ranking dari masing-masing Tryout yang telah diikuti sehingga Peserta tahu dimana posisi dia dibanding dengan Peserta lainnya.</p>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
                                    <a class="card text-center text-decoration-none h-100 lift">
                                        <div class="card-body py-5">
                                            ...
                                            <h5>Webinar</h5>
                                            <p class="card-text small">Peserta dapat mengikuti webinar via Zoom Meeting yang bertujuan untuk mengevaluasi kegiatan pembelajaran</p>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="150">
                                    <a class="card text-center text-decoration-none h-100 lift">
                                        <div class="card-body py-5">
                                            ...
                                            <p class="card-text small">Selain bermanfaat bagi diri sendiri, Peserta dapat mengajakan teman-teman lainnya kedalam sistem {{ $setting->app_name ?? '' }}, dan Peserta tersebut akan mendapatkan komisi ketika Peserta baru mengikuti link nya dan melakukan transaksi.</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12" data-aos="fade-up">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <h5 class="card-title">Halaman Tryout</h5>
                                            <p class="card-text">
                                                Tampilan halaman Tryout dengan soal matematika. menampilkan nomor soal serta navigasi soal agar Peserta tahu soal mana saja yang sudah dijawab.
                                            </p>
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="card pricing h-100">
                                        <div class="card-body p-5">
                                            ...
                                            <ul class="fa-ul pricing-list">
                                                ...
                                                <li class="pricing-list-item">
                                                    <span class="fa-li"><i class="far fa-circle text-gray-200"></i></span>
                                                    <span class="text-dark">Mengikuti Tryout</span>
                                                </li>
                                                <li class="pricing-list-item">
                                                    <span class="fa-li"><i class="far fa-circle text-gray-200"></i></span>
                                    ...
                                    <div class="card pricing h-100">
                                        <div class="card-body p-5">
                                            ...
                                            <ul class="fa-ul pricing-list">
                                                <li class="pricing-list-item">
                                                    <span class="fa-li"><i class="far fa-check-circle text-teal"></i></span>
                                                    <span class="text-dark">Tryout Full Akses</span>
                                                </li>
                                                <li class="pricing-list-item">
                                                    <span class="fa-li"><i class="far fa-check-circle text-teal"></i></span>
                                                    <span class="text-dark">Pembahasan untuk Tiap-tiap Soal</span>
                                ...
                                <div class="col-lg-6 mb-5 mb-lg-0">
                                    <div class="d-flex h-100">
                                        ...
                                        <div class="ms-4">
                                            ...
                                            <p class="text-white-50">Ya, anda akan mendapatkan informasi ketika anda join di group Whatsapp kami. silakan hubungi admin, dan admin akan mengundang anda secara khusus untuk bergabung dengan Peserta lainnya di {{ $setting->app_name ?? '' }}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
