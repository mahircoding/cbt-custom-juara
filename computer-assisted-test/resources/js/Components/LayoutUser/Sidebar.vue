    ...
    <!--sidebar wrapper -->
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu" v-if="$page.props.auth.user.level == 1">
                ...
                <li>
					...
					<ul>
						...
						<li> <a href="#"><i class="bx bx-right-arrow-alt"></i>Grup Tryout</a></li>
						<li> <a href="#"><i class="bx bx-right-arrow-alt"></i>Sesi Tryout</a></li>
					</ul>
				</li>
            ...
            <ul class="metismenu" id="menu" v-if="$page.props.auth.user.level == 2">
                ...
                <li class="menu-label">Tryout & Tryout</li>
                <li>
					<a href="javascript:;" class="has-arrow">
						<div class="parent-icon"><i class='bx bx-message-square-edit'></i>
						</div>
