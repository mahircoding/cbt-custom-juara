                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data Kategori Tryout</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12" v-for="category in categories">
                    <div class="card">
                        <div class="row g-0">
                            ...
                            <div class="col-md-7">
                                <div class="card-body">
                                    <h5 class="card-title">Tryout {{ category.name }}</h5>
                                    <p class="card-text">Tryout dari berbagai tes untuk menentukan nilai akhir dalam seleksi {{ category.name }}.</p>
                ...
                <div class="row row-cols-12 row-cols-md-12 row-cols-lg-12 row-cols-xl-12">
                    <div class="col">
                        <div class="card border-bottom border-3 border-0">
                            <div class="card-body">
                                <h5 class="card-title text-center">Data Tryout Belum Tersedia</h5>
                            </div>
                        </div>
                    </div>
                </div>
