<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Tambah Ruang Kelas</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tambah Ruang Kelas</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            const submit = () => {
                ...
                Inertia.post('/admin/classrooms', {
                    ...
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Ruang Kelas Berhasil Disimpan!.',
                            icon: 'success',
