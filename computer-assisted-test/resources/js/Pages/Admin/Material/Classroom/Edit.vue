<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Edit Ruang Kelas</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Ruang Kelas</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            const submit = () => {
                ...
                Inertia.put(`/admin/classrooms/${props.classroom.id}`, {
                    ...
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Ruang KelasBerhasil Diupdate!.',
                            icon: 'success',
