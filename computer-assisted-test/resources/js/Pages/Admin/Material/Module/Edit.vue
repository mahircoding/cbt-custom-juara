            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label">Tipe Periode Masa Aktif <small><i><b>(Opsional — digunakan jika sistem penjualan per modul/materi. Jika tidak diisi, maka akses pengguna ke modul/materi akan berlaku selamanya tanpa batas waktu.)</b></i></small></label>
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                ...
                period_type: props.module.period_type ?? '',
                active_period: props.module.active_period ?? '',
