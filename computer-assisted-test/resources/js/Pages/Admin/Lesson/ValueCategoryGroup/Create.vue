<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Tambah Kelompok Kategori Penilaian</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tambah Kelompok Kategori Penilaian</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const submit = () => {
                // send data to server
                Inertia.post('/admin/value-category-groups', {
                    // data
                    name: form.name,
                    ...
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'Kelompok Kategori Penilaian Berhasil Disimpan!.',
                            icon: 'success',
