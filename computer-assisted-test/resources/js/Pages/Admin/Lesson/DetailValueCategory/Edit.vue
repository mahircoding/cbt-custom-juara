            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center">
                        <div class="ms-auto">
                            <Link :href="`/admin/value-category-groups/${valueCategoryGroup.id}/value-categories/${valueCategory.id}/detail-value-categories`" class="btn btn-primary btn-sm mt-2 mt-lg-0">Kembali</Link>
                        </div>
                    </div>
                    <form @submit.prevent="submit" class="row g-3">
                        <div class="col-12">
                            <label class="form-label">Nilai Minimal (Jika dikosongkan, akan mengambil nilai terkecil tak hingga)</label>
                        ...
                        <div class="col-12">
                            <label class="form-label">Nilai Maksimal (Jika dikosongkan, akan mengambil nilai terbesar tak hingga)</label>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" v-model="form.final_grade" :class="{ 'is-invalid': errors.final_grade }" placeholder="Skor">
...
<script>
    ...
    export default {
        ...
        setup(props) {
            ...
            const submit = () => {
                // send data to server
                Inertia.put(`/admin/value-category-groups/${props.valueCategoryGroup.id}/value-categories/${props.valueCategory.id}/detail-value-categories/${props.detailValueCategory.id}`, {
                    // data
