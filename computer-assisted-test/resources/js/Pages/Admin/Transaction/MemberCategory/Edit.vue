<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Edit Kategori Member</title>
    </Head>
    <!--start page wrapper -->
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                ...
                description: props.memberCategory.description,
            ...
            const submit = () => {
                // send data to server
                Inertia.post(`/admin/member-categories/${props.memberCategory.id}`, {
                    _method: 'put',
                    // data
                    name: form.name,
