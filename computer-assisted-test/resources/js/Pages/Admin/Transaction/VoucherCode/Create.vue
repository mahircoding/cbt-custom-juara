<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Tambah Kode Voucher</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tambah Kode Voucher</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" v-model="form.code" :class="{ 'is-invalid': errors.code }" placeholder="Kode Voucher">
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const submit = () => {
                // send data to server
                Inertia.post('/admin/voucher-codes', {
                    // data
                    code: form.code,
