<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Data Bank / E-Wallet</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Data Bank / E-Wallet</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    <div class="d-lg-flex align-items-center mb-4 gap-3">
                        ...
                        <div class="ms-auto">
                            <Link href="/admin/banks/create" class="btn btn-primary btn-sm mt-2 mt-lg-0"><i class="bx bxs-plus-square"></i> Tambah Data</Link>
                        </div>
                    </div>
                        ...
                        <table class="table mb-0" style="font-size:10pt;">
                            ...
                            <tbody>
                                <tr v-for="(bank, index) in banks.data" :key="index">
                                    ...
                                    <td>{{ bank.type == 1 ? 'Bank' : 'E-Wallet' }}</td>
                                    <td>
                                        <div v-if="bank.image">
                                ...
                                <tr>
                                    <td align="center" colspan="7" v-if="!banks.data.length">Data Tidak Tersedia</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
