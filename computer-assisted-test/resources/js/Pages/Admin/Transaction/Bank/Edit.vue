            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label">Nama {{ form.type == "1" ? 'Bank' : 'E-Wallet' }}</label>
                            <input type="text" class="form-control" v-model="form.bank_name" :class="{ 'is-invalid': errors.bank_name }" :placeholder="form.type == '1' ? 'Nama Bank' : 'Nama E-Wallet'">
                            <div v-if="errors.bank_name" class="invalid-feedback">
                                {{ errors.bank_name }}
                            </div>
                        </div>
                        <div class="col-12">
                            <label class="form-label">Logo {{ form.type == "1" ? 'Bank' : 'E-Wallet' }}</label>
                        ...
                        <div class="col-12">
                            <label class="form-label">Nomor {{ form.type == "1" ? 'Rekening' : 'E-Wallet' }}</label>
                            <input type="text" class="form-control" v-model="form.rekening_number" :class="{ 'is-invalid': errors.rekening_number }" :placeholder="form.type == '1' ? 'Nomor Rekening' : 'Nomor E-Wallet'">
