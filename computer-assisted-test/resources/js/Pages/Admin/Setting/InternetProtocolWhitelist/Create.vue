<template>
    <Head>
        <title>{{ $page.props.setting.app_name ?? 'Atur Setting Terlebih Dahulu' }} - Tambah IP Whitelist</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="ps-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Tambah IP Whitelist</li>
                        </ol>
                    </nav>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        setup() {
            ...
            const submit = () => {
                // send data to server
                Inertia.post('/admin/internet-protocol-whitelists', {
                    // data
                    ip: form.ip,
                    name: form.name,
                }, {
                    onSuccess: () => {
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'IP Whitelist Berhasil Disimpan!.',
                            icon: 'success',
