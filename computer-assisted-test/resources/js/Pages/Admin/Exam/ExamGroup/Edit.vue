            ...
            <div class="card border-top border-0 border-3 border-primary">
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1">
                            <label class="form-label">Peserta Dapat Mengulangi Ujian Tryout</label>
                        ...
                        <div class="col-12" v-if="form.exam_group_type == 1 && form.repeat_the_exam != 0">
                            <label class="form-label">Batasan Mengulangi (Kosongkan Jika Tidak Ada Batasan)</label>
                            <input v-model="form.repeat_limit" type="text" :class="{ 'is-invalid': errors.repeat_limit }" class="form-control" placeholder="Batasan Mengulangi">
                        ...
                        <div class="col-12">
                            <label class="form-label">Tipe Periode Masa Aktif <small><i><b>(Opsional — digunakan jika sistem penjualan per tryout. Jika tidak diisi, maka akses pengguna ke tryout akan berlaku selamanya tanpa batas waktu.)</b></i></small></label>
                        ...
                        <div class="col-12">
                            <label class="form-label">Kode Link Pendek Tryout (Optional)</label>
                        ...
                        <span class="mt-2">
                            <code v-if="form.short_code_link">Hasil : {{ $page.props.setting.app_url }}/tryout/{{ form.short_code_link }}</code>
                        </span>
...
<script>
    ...
    export default {
        ...
        setup(props) {
            const form = reactive({
                id: props.examGroup.id,
                user_id: props.examGroup.user_id ?? '',
                ...
                repeat_limit: props.examGroup.repeat_limit ?? '',
                ...
                short_code_link: props.examGroup.short_code_link,
                ...
                period_type: props.examGroup.period_type ?? '',
                active_period: props.examGroup.active_period ?? '',
