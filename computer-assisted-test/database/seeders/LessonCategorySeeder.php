    ...
    public function run()
    {
        LessonCategory::insert([
            [
                ...
                "description" => "Berisi berbagai jenis Tryout mulai dari tes kecerdasan, kecermatan dan kepribadian"
            ],
            [
                ...
                "description" => "Berisi berbagai jenis Tryout semua mapel tes akademik persiapan seleksi anggota POLRI"
            ],
            [
            ...
            [
                ...
                "description" => "BerisI paket Tryout Tes Wawasan Kebangsaan, Tes Intelegensi Umum, dan Tes Karakteristik Pribadi"
            ],
            [
                ...
                "description" => "Berisi paket Tryout Tes Seleksi Kemampuan Bidang yang diujikan pada beberapa sekolah kedinasan"
            ],
            [
                ...
                "description" => "Berisi paket Tryout lainnya seperti tes Psikologi, Kesehatan Jiwa, dan lain - lain"
            ],
            [
