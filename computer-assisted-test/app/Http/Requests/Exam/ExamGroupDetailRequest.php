...
class ExamGroupDetailRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'show_ranking_exam' => 'required_if:exam_group_type, 2',
    ...
    public function attributes()
    {
        return [
            ...
            'question_selection_mode' => __('exam_group_detail.question_selection_mode'),
            'number_of_questions' => __('exam_group_detail.number_of_questions'),
