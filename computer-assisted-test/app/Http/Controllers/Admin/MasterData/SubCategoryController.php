...
class SubCategoryController extends Controller
{
    ...
    {
        Session::put('queryStringSubCategories', $request->getQueryString());
    ...
    public function update(SubCategoryRequest $request, $id)
    {
        try {
            ...
            $queryString = Session::get('queryStringSubCategories');
            return redirect(route('admin.sub-categories.index') . (!empty($queryString) ? '?'.$queryString : ''));
