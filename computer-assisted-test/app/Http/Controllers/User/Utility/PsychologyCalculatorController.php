...
class PsychologyCalculatorController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return inertia('User/Utility/PsychologyCalculator/Index', [
    ...
    public function calculateScore($categoryId, $valueCategoryGroupId)
    {
        try {
            ...
            if(!$category) {
                ...
                return redirect()->route('user.psychology-calculators.index');
            }
            ...
            return inertia('User/Utility/PsychologyCalculator/CalculateScore', [
                'category' => $category,
